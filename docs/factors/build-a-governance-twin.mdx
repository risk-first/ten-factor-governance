...
- [Sensitive Activity](/docs/artifacts/definitions/operate/sensitive-activity) — activity the twin governs
- Governance Artifacts such as:

  - [Guidance](/docs/artifacts/definitions/define/guidance) 
  - [Principle](/docs/artifacts/definitions/define/principle)
